# Primitive Cell Without Spin-Orbit Coupling:
#Valance Band = 14, Conduction Band =15
...
# Designing the graph:
plt.scatter(k1, e1, s=w1, c=w1, cmap = 'Blues', label = 'Bi')
plt.colorbar()
plt.scatter(k2, e2, s=w2, c=w2, cmap = 'Reds', label = 'Se')
plt.colorbar()

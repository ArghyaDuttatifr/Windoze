...
M = 5.92e24
V= 80000.0/36.0
omega = 4.544e-5   #( double of actual value)
...
psi=(pi/180.0)*60         #the initial angle for launch with the horizontal (in rad)
'''
psi=(pi/180.0)*45
psi=(pi/180.0)*30
psi=(pi/180.0)*60
...
'''
theta=(pi/180.0)*81.5         # Polar angle is equal to (90-latitude) (in rad)
